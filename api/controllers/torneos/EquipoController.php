...
class EquipoController extends BaseController
{
        ...
        try {
            ...
            if ($torneoActivo) {
                ...
                $detalle = $nombreTorneo !== ''
                    ...
                    : '';
                $this->respond(409, [
                    'message' => 'No se puede dar de baja: el equipo est� inscripto en un torneo activo' . $detalle . '.',
                ]);
            }
    ...
    public function subirEscudo(): void
    {
        try {
            ...
            if (!is_array($file) || !isset($file['error'])) {
                $this->respond(400, ['message' => 'Archivo de escudo inv�lido.']);
            }

            if ((int)$file['error'] !== UPLOAD_ERR_OK) {
                $this->respond(400, ['message' => 'Error al subir el escudo. C�digo: ' . (string)$file['error']]);
            }
            ...
            if ($tmpPath === '' || !is_uploaded_file($tmpPath)) {
                $this->respond(400, ['message' => 'No se encontr� el archivo temporal del escudo.']);
            }
    ...
    private function resolveEscudosDirectory(): string
    {
        ...
        $candidates[] = dirname(__DIR__, 3) . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'escudos';
